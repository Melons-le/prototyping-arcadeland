    ...
    void CamMovementUD()
    {
        if (!vehicleAI.enabled)
        {
            if (b_Up)
            {
                ...
                float smoothGampadMove = vehicleInputs.ReturnUpInputValue();    // When player use Gamepad movement depend of the value of the axis. Create smotther movement.
            ...
            else if (b_Down)
            {
                ...
                float smoothGampadMove = vehicleInputs.ReturnDownInputValue();    // When player use Gamepad movement depend of the value of the axis. Create smotther movement.
